      ...
      onResolved={(userResource: any) => {
        ...
        return (
          ...
          >
            ...
            <div class="flex flex-col items-center max-lg:sticky max-lg:top-[96px] max-lg:w-full max-md:relative max-md:top-0">
              <div class="flex flex-col gap-4 h-fit w-[360px] border-[0.2px] border-neutral-800 bg-[#16161640] rounded-md p-2 sticky top-[120px] max-xl:w-[320px] max-lg:w-full max-lg:grid max-lg:grid-cols-3 max-lg:rounded-none max-lg:bg-[#161616]  max-md:flex max-md:flex-col max-md:relative max-md:top-0 max-md:p-4">
                ...
                <img
                  src={
                    experienceInfo[
                      Object.keys(experienceInfo)[currOption.value]
                    ].img1
                  }
                  alt="Project Banner"
                  loading="lazy"
                ...
                <div class="flex flex-col gap-2 max-lg:justify-center max-lg:gap-2 max-lg:overflow-hidden">
                  ...
                  <Dropdown currOption={currOption} userInfo={experienceInfo} />
            ...
            <div class="col-span-2 px-8 flex flex-col gap-4 w-[92%] max-w-[840px] max-xl:w-[96%] max-md:px-4">
              <h4 class="h4 mb-6 w-[80%]">
                {
                  experienceInfo[Object.keys(experienceInfo)[currOption.value]]
                    .title
                }
              </h4>
              <p class="p1">
